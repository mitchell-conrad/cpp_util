...
class ipv4 {
public:
  [[nodiscard]] static auto from_string(const std::string& addr_string) -> ipv4
  {
...
std::ostream& operator<<(std::ostream& out, const ipv4& addr)
{
  return out << addr.to_string();
}
auto operator==(const ipv4& a, const ipv4& b)
{
